"""
Given two strings, check if one can be obtained from the other by cyclically shifting its characters.
If so, return the number of positions by which the characters were shifted.
"""
