"""
This program determines the maximum number of people who can take roller skates and go skating simultaneously, given the list of N skate sizes and the list of K foot sizes.
"""
