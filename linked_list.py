"""
A module that implements a singly linked list data structure in Python without using standard data structures.

The linked list consists of nodes that store data, and the nodes are connected with links pointing to the next node.
This module implements the following methods for the linked list:

- append: adds an element to the end of the list
- get: retrieves an element by its index
- remove: removes an element by its index
- iter: allows iteration over the linked list with a loop
"""
