"""
This program processes data obtained from a cryptocurrency exchange site API in form of a dictionary,
by printing the keys and values of the dictionary, adding new keys to the "ETH" dictionary, changing the value of
a key in "fst_token_info", deleting a key in "tokens" and assigning its value to a key in "ETH",
and renaming a key in "sec_token_info".
"""
