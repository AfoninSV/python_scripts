"""
Create a program that simulates a game of blackjack, 
allowing the user to hit or stay, and determines the winner based on the sum of their cards, 
using a Card class to represent each card.
"""
