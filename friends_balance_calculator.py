"""
Calculates the total amount each friend owes or is owed based on a set of debt notes.

The program takes as input the number of friends, the number of debt notes, and a set of triples
containing the ID of the friend who borrowed money, the ID of the friend who lent money, and the amount borrowed.
The program then calculates the balance for each friend, i.e. the amount they owe or are owed by others.
"""
