"""
Implement a car class and a bus class that inherits from the car class, 
with additional fields for passengers and earnings, 
and a move method that updates the earnings based on the number of passengers and distance traveled.
"""
