"""
A program that takes a shop inventory list of parts with their prices, 
prompts the user for a part name, calculates the quantity of the part in stock, 
and calculates the total cost of that part.
"""
